        ...
        <div class="header__nav">
          <div class="header__nav-item">
            <router-link to="/" class="header__nav-link">
              Neuanträge <span>{{ count }}</span>
            </router-link>

          </div>
          <div class="header__nav-item">
            <router-link to="/free" class="header__nav-link">
              Nicht gebuchte Spinde
            </router-link>
          </div>
          <div class="header__nav-item">
            <router-link to="/reserved" class="header__nav-link">
              Belegte Spinde
            </router-link>
          </div>
          <div class="header__nav-item">
            <router-link to="/all" class="header__nav-link">
              Spindverwaltung
            </router-link>
          </div>
          <div class="header__nav-item">
          ...
          <div class="header__nav-item header__nav-item_last">
            <a href="#settings" uk-toggle class="header__nav-link">
              <svg width="32px" height="32px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><title>
                file_type_light_config</title>
                <path
...
export default {
  ...
  computed: {
    ...mapGetters({
      count: 'internalVariables/getCount'
    })
  },
   watch: {
     count: function(val) {
        console.log(val, 'asfasfasf')
     }
   }
}
</script>
